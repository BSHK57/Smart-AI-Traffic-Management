...
passwordEl.addEventListener('input', () => {
    const passwordValid = passwordEl.value.length >= 8 &&
        /[A-Z]/.test(passwordEl.value) &&
        /[a-z]/.test(passwordEl.value) &&
        /\d/.test(passwordEl.value) &&
        /[^A-Za-z0-9]/.test(passwordEl.value);
...
submitBtn.addEventListener('click', function (e) {
    ...
    const userEmail = "ryashwanth2005@gmail.com";
    const userPassword = "Hack@2025";
